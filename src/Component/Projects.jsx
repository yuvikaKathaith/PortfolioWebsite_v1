        ...
        <section className="py-20 px-4 sm:px-6 md:px-10 flex flex-col items-center">
          ...
          >
            <div className="flex items-center mb-4 md:mb-0">
              <h1 className="text-[#ccd6f6] text-[24px] md:text-[27px] font-semibold mr-0 md:mr-4">
          ...
          >
            <div className="w-full md:w-[700px] h-[220px] md:h-[370px] relative z-10 group">
            ...
            <div className="z-20 md:-ml-14 mt-6 md:mt-0">
              <div className="text-right md:text-right p-3 -mr-0 md:-mr-3">
                <p className="text-[#64ffda] text-[15px] font-mono">Featured Project</p>
                <Link
                  href="https://bingebuddy-react.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white text-[24px] md:text-[28px] font-semibold font-inter hover:text-[#64ffda] cursor-pointer"
                >
                  BingeBuddy
                </Link>
              </div>
              <div className="w-full md:w-[500px] text-[#a8b2d1] bg-[#112240] p-4 md:p-6 text-right md:text-right font-inter text-[15px] rounded-sm mt-3">
                <p className="mb-4">
              ...
              <div className="text-[#a8b2d1] font-mono">
                <ul className="flex flex-wrap gap-4 text-sm justify-end pt-5">
                  <li>React.js</li>
                  <li>Firebase</li>
                  <li>Redux Toolkit</li>
                  <li>Groq AI API</li>
          ...
          >
            <div className="z-20 md:-mr-18 mt-6 md:mt-0 order-2 md:order-1">
              ...
              <div className="w-full md:w-[600px] text-[#a8b2d1] bg-[#112240] p-4 md:p-6 text-left font-inter text-[15px] rounded-sm mt-3">
                <p className="mb-4">
              ...
              <div className="text-[#a8b2d1] font-mono">
                <ul className="flex flex-wrap gap-4 text-sm justify-start pt-5">
                  <li>Next.js</li>
                  <li>React.js</li>
                  <li>TypeScript</li>
                  <li>Tailwind CSS</li>
            ...
            <div className="w-full md:w-[720px] h-[220px] md:h-[370px] relative z-10 group order-1 md:order-2">
              <Link href="https://stampick.vercel.app/" target="_blank" rel="noopener noreferrer">
          ...
          >
            <div className="w-full md:w-[700px] h-[220px] md:h-[350px] relative z-10 group">
            ...
            <div className="z-20 md:-ml-18 mt-6 md:mt-0">
              ...
              <div className="w-full md:w-[500px] text-[#a8b2d1] bg-[#112240] p-4 md:p-6 text-right font-inter text-[15px] rounded-sm mt-3">
                <p className="mb-4">
