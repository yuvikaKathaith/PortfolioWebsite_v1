...
const About = () => {
  return (
    <Element name="about">
      <section className="gap-10 font-inter w-full mx-auto px-10 py-10 lg:py-16 text-[16px] flex flex-col md:flex-row items-center justify-center max-w-screen-xl">
        {/* Text Section */}
        <motion.div
        ...
        >
          <div className="flex items-center py-8">
            <h2 className="text-[#ccd6f6] text-[20px] md:text-[24px] font-semibold mr-4">
              <span className="font-normal font-mono text-lg md:text-2xl text-[#64ffda]">
                01.
              </span>{" "}
              About Me
            </h2>
          ...
          <ul className="text-[#8892b0] font-mono text-[12px] grid lg:grid-cols-3 grid-cols-2 pt-5">
            {[
              "JavaScript (ES6+)",
              "TypeScript",
              "React",
          ...
          <p className="text-[#8892b0] mt-6 text-[14px] md:text-base">
