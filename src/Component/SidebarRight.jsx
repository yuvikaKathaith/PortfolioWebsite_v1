  ...
  return (
    <>
      <motion.div
        ...
        className="hidden lg:flex max-w-40 right-0 bottom-0 fixed flex-col items-end z-50 gap-50"
      >
        <div className="rotate-90 cursor-pointer text-md max-w-28 transition-transform hover:-translate-y-2 duration-300">
