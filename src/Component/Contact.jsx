    ...
    <>
      <Element name="contact">
        ...
        >
          ...
          >
            <button className="transition-transform hover:-translate-y-1 duration-300 w-33 h-13 bg-transparent border border-[#64ffda] text-[#64ffda] rounded-sm text-sm font-mono hover:bg-[#64ffda]/10 text-[14px] mt-3">
              Mail Me
            </button>
          </a>
        </motion.div>
