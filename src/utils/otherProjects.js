export const projectsData = [
  {
    ...
    description:
      "A sleek SPA built with React that lets users explore a wide range of Pokémon with features like type-based filtering, search, pagination, sorting, detailed Pokémon pages and mark favourites.",
    github: "https://github.com/yuvikaKathaith/poke-explorer",
    live: "https://poke-explorer-rho.vercel.app/", 
    techs: ["React", "Tailwind", "PokéAPI", "React Router", "Context API"],
    year: 2025,
  },
  {
    id: 2,
